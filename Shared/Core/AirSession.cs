...
namespace Nsnbc.Core
{
 ...
 public class AirSession
 {
     ...
     [Trace(AttributeExclude = true)] public bool FastForwarding { get; set; }
     ...
     public void AddItemWithAnimation(InventoryItem inventoryItem)
     {
         Session.Inventory.Add(inventoryItem);
         AnimateItemGet(inventoryItem);
     }

     public void AnimateItemGet(InventoryItem inventoryItem)
     {
         this.ActiveActivities.Add(new ItemGetActivity(inventoryItem));
     }
 }
}